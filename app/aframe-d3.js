...
var bars = scene.selectAll("a-cube").data(data)
bars.enter().append("a-cube")

// we set attributes on our cubes to determine how they are rendered
bars.attr("position", function(d,i) {
...
bars.attr("rotation", function(d,i) {
    var x = 0;
    var z = 0;
...
bars.attr("width", 0.5);
bars.attr("depth", 0.9);
bars.attr("height", function(d) { return hscale(d)});
bars.attr("opacity", function(d,i) { return 0.6 + (i/data.length) * 0.4});
